...
const AboutPage =()=>{
  return(
    <div className="container my-10 mx-5 md:mx-auto flex flex-col md:flex-row border-4 p-6 md:p-12 justify-between items-center border-black rounded-3xl space-y-10 md:space-x-40">
      <div>
        <Image src={srmImage} width={2500}/>
      </div>
      
      <div className="flex flex-col justify-between items-center space-y-10 md:space-y-20">
        <div className="text-lg md:text-3xl text-justify">
